...
export const PostCard = ({ post, large = false }) => {
  ...
  return (
    <article
      className={`post-card ${post.feature_image ? "" : "no-image"} ${
    ...
    >
      ...
      <PostCardContent className="post-card-content">
        <PostCardHeader className="post-card-header">
            ...
            <PostCardPrimaryTag className="post-card-primary-tag">
              {post.tags.map((tag, idx) => (
                <React.Fragment key={idx}>
                  {idx > 0 && <>, &nbsp;</>}
                  <Link to={`/tags/${_.kebabCase(tag.name)}/`}>{tag.name}</Link>
                </React.Fragment>
              ))}
            </PostCardPrimaryTag>
          )}
          ...
          <Link to={`/blog/${post.slug}`} css={PostCardContentLink}>
        ...
        <PostCardMeta className="post-card-meta">
          ...
          <PostCardBylineContent className="post-card-byline-content">
            ...
            <span className="post-card-byline-date">
              ...
              <span className="bull">&bull;</span> {post.reading_time} MIN READ
            </span>
